...
namespace ATI_Projet_App.Components.Pages.Gestion
{
    public partial class GestionList : ComponentBase
    {
        ...
        private async Task OpenModalAdd()
        {
            ...
            {
                case "Fonction":
                    await CreateModalAdd<Fonction>("Ajout d'une fonction");
                    break;
                case "FonctionVCA":
                    await CreateModalAdd<FonctionVCA>("Ajout d'une fonctionVCA");
                    break;
                case "StatusVCA":
                    await CreateModalAdd<StatusVCA>("Ajout d'un status VCA");
                    break;
                case "TypeContrat":
                    await CreateModalAdd<TypeContrat>("Ajout d'un type de contrat");
                    break;
                case "TypeMO":
                    await CreateModalAdd<TypeMO>("Ajout d'un type de main d'oeuvre");
                    break;
            }
        }
